...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    announcement_bar: Attribute.Component<'layout.promo-bar'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    flyout_nav: Attribute.Component<'links.nested-link', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    ...
    product_rails: Attribute.Component<'content.product-rail', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
